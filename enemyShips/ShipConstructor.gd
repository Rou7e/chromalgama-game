...
func _process(delta):
	#$UVBeam.visible = Input.get_action_strength("shoot")
	pass
...
func _physics_process(delta):
	...
	#global_position.x -= sin(global_rotation)*input_vector.y*acceleration*delta*10
	#global_position.y += cos(global_rotation)*input_vector.y*acceleration*delta*10
	pass
